...
def generate_launch_description():
    ...
    kine_yaml = load_yaml("ovis_moveit_config", "config/kinematics.yaml")
    kine_params = {"moveit_servo": kine_yaml}
    joint_limits_yaml = load_yaml("ovis_moveit_config", "config/joint_limits.yaml")
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("ovis_moveit_config"),
        "config",
    ...
    container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                ...
                parameters=[{"child_frame_id": "/ovis_link_base", "frame_id": "/world", "use_sim_time": True}],
            ),
            ComposableNode(
                package="ovis_servo",
