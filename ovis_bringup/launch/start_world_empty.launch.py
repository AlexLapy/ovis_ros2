...
def generate_launch_description():
    ...
    pkg_box_bot_gazebo = get_package_share_directory('ovis_bringup')

    # Add to path the models for Ingestors and Digestors
    extra_models_package = "ovis_description"
    extra_models_package_path = get_package_share_directory(extra_models_package)
    extra_models_path = os.path.join(extra_models_package_path, 'meshes')
